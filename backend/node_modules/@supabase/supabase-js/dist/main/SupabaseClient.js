...
class SupabaseClient {
     ...
     * @param SUPABASE_SERVICE_ROLE_KEY The unique Supabase Key which is supplied when you create a new project in your project dashboard.
     ...
     */
    constructor(supabaseUrl, SUPABASE_SERVICE_ROLE_KEY, options) {
        var _a, _b, _c;
        ...
        this.fetch = (0, fetch_1.fetchWithAuth)(SUPABASE_SERVICE_ROLE_KEY, this._getAccessToken.bind(this), settings.global.fetch);
    ...
    _initRealtimeClient(options) {
        return new realtime_js_1.RealtimeClient(this.realtimeUrl, Object.assign(Object.assign({}, options), { params: Object.assign({ apikey: this.SUPABASE_SERVICE_ROLE_KEY }, options === null || options === void 0 ? void 0 : options.params) }));
    }
