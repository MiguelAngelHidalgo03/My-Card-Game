...
export default class GameState {
  ...
  static fromServerPayload(payload) {
      console.log('[GameState.fromServerPayload] chosenColor recibido:', payload.chosenColor);
    ...
    return new GameState({
      ...
      lastColorChooser: payload.lastColorChooser,
      pendingPenalty: payload.pendingPenalty
    });
  }
